...
class ParticipanteModel {
    ...
    public function insertarActividad($cod_participante,$acF1,$acF2,$acF3,$acF4,$acF5,$acF6,$acF7) {
        try {
            $sql = 'INSERT INTO actividad (cod_participante, AcF1, AcF2, AcF3, AcF4, AcF5, AcF6, AcF7) VALUES (:cod_participante, :acF1, :acF2, :acF3, :acF4, :acF5, :acF6, :acF7)
                   ON DUPLICATE KEY UPDATE AcF1=VALUES(AcF1), AcF2=VALUES(AcF2), AcF3=VALUES(AcF3), AcF4=VALUES(AcF4), AcF5=VALUES(AcF5), AcF6=VALUES(AcF6), AcF7=VALUES(AcF7)';
            $stmt = $this->conexionDB->prepare($sql);
        ...
        public function insertarAlimentacion($cod_participante,$Ali1,$Ali2,$Ali3,$Ali4,$Ali5,$Ali6,$Ali7,$Ali8,$Ali9,$Ali10,$Ali11,$Ali12,$Ali13,$Ali14) {
            try {
                $sql = 'INSERT INTO alimentacion (cod_participante, Ali1, Ali2, Ali3, Ali4, Ali5, Ali6, Ali7, Ali8, Ali9, Ali10, Ali11, Ali12, Ali13, Ali14) VALUES (:cod_participante, :ali1, :ali2, :ali3, :ali4, :ali5, :ali6, :ali7, :ali8, :ali9, :ali10, :ali11, :ali12, :ali13, :ali14)
                        ON DUPLICATE KEY UPDATE Ali1=VALUES(Ali1), Ali2=VALUES(Ali2), Ali3=VALUES(Ali3), Ali4=VALUES(Ali4), Ali5=VALUES(Ali5), Ali6=VALUES(Ali6), Ali7=VALUES(Ali7), Ali8=VALUES(Ali8), Ali9=VALUES(Ali9), Ali10=VALUES(Ali10), Ali11=VALUES(Ali11), Ali12=VALUES(Ali12), Ali13=VALUES(Ali13), Ali14=VALUES(Ali14)';
                $stmt = $this->conexionDB->prepare($sql);
                $stmt->bindParam(':cod_participante', $cod_participante);
    ...
    public function insertarSuenyo($cod_participante,$Sue1,$Sue2,$Sue3,$Sue4,$Sue5a, $Sue5b,$Sue5c,$Sue5d,$Sue5e,$Sue5f,$Sue5g,$Sue5h,$Sue5i,$Sue5j,$Sue5j_Desc,$Sue6,$Sue7,$Sue8,$Sue9,$Sue10) {
        try {
            $sql = 'INSERT INTO sueno (cod_participante, Sue1, Sue2, Sue3, Sue4, Sue5a, Sue5b, Sue5c, Sue5d, Sue5e, Sue5f, Sue5g, Sue5h, Sue5i, Sue5j, Sue5j_Desc, Sue6, Sue7, Sue8, Sue9, Sue10) VALUES (:cod_participante, :sue1, :sue2, :sue3, :sue4, :sue5a, :sue5b, :sue5c, :sue5d, :sue5e, :sue5f, :sue5g, :sue5h, :sue5i, :sue5j, :sue5j_Desc, :sue6, :sue7, :sue8, :sue9, :sue10)
                   ON DUPLICATE KEY UPDATE Sue1=VALUES(Sue1), Sue2=VALUES(Sue2), Sue3=VALUES(Sue3), Sue4=VALUES(Sue4), Sue5a=VALUES(Sue5a), Sue5b=VALUES(Sue5b), Sue5c=VALUES(Sue5c), Sue5d=VALUES(Sue5d), Sue5e=VALUES(Sue5e), Sue5f=VALUES(Sue5f), Sue5g=VALUES(Sue5g), Sue5h=VALUES(Sue5h), Sue5i=VALUES(Sue5i), Sue5j=VALUES(Sue5j), Sue5j_Desc=VALUES(Sue5j_Desc), Sue6=VALUES(Sue6), Sue7=VALUES(Sue7), Sue8=VALUES(Sue8), Sue9=VALUES(Sue9), Sue10=VALUES(Sue10)';
            $stmt = $this->conexionDB->prepare($sql);
            $stmt->bindParam(':cod_participante', $cod_participante);
    ...
    public function insertarAntropometrico($cod_participante,$ant1,$ant2,$ant3,$ant4,$ant5,$ant6,$ant7,$ant8,$ant9,$ant10,$ant11,$ant12,$ant13,$ant14,$ant15,$ant16,$ant17,$ant18_BD,$ant18_BI,$ant18_PD,$ant18_PI,$ant19_BD,$ant19_BI,$ant19_PD,$ant19_PI,$ant20,$ant21) {
        try {
            $sql = 'INSERT INTO antropometrico (cod_participante, Ant1, Ant2, Ant3, Ant4, Ant5, Ant6, Ant7, Ant8, Ant9, Ant10, Ant11, Ant12, Ant13, Ant14, Ant15, Ant16, Ant17, Ant18_BD, Ant18_BI, Ant18_PD, Ant18_PI, Ant19_BD, Ant19_BI, Ant19_PD, Ant19_PI, Ant20, Ant21) VALUES (:cod_participante, :ant1, :ant2, :ant3, :ant4, :ant5, :ant6, :ant7, :ant8, :ant9, :ant10, :ant11, :ant12, :ant13, :ant14, :ant15, :ant16, :ant17, :ant18_BD, :ant18_BI, :ant18_PD, :ant18_PI, :ant19_BD, :ant19_BI, :ant19_PD, :ant19_PI, :ant20, :ant21)
                   ON DUPLICATE KEY UPDATE Ant1=VALUES(Ant1), Ant2=VALUES(Ant2), Ant3=VALUES(Ant3), Ant4=VALUES(Ant4), Ant5=VALUES(Ant5), Ant6=VALUES(Ant6), Ant7=VALUES(Ant7), Ant8=VALUES(Ant8), Ant9=VALUES(Ant9), Ant10=VALUES(Ant10), Ant11=VALUES(Ant11), Ant12=VALUES(Ant12), Ant13=VALUES(Ant13), Ant14=VALUES(Ant14), Ant15=VALUES(Ant15), Ant16=VALUES(Ant16), Ant17=VALUES(Ant17), Ant18_BD=VALUES(Ant18_BD), Ant18_BI=VALUES(Ant18_BI), Ant18_PD=VALUES(Ant18_PD), Ant18_PI=VALUES(Ant18_PI), Ant19_BD=VALUES(Ant19_BD), Ant19_BI=VALUES(Ant19_BI), Ant19_PD=VALUES(Ant19_PD), Ant19_PI=VALUES(Ant19_PI), Ant20=VALUES(Ant20), Ant21=VALUES(Ant21)';
            $stmt = $this->conexionDB->prepare($sql);
            $stmt->bindParam(':cod_participante', $cod_participante);
    ...
    public function familiaIMC(){
        $sql = "SELECT familia_profesional, AVG(ant4) AS imc_promedio 
        FROM participante p 
        JOIN antropometrico a ON p.cod_participante = a.cod_participante 
    ...
    public function sexoIMC(){
        $sql = "SELECT sexo, AVG(ant4) AS imc_promedio 
        FROM participante p 
        JOIN antropometrico a ON p.cod_participante = a.cod_participante 
    ...
    public function centroIMC(){
        $sql = "SELECT centro_educativo, AVG(ant4) AS imc_promedio 
        FROM participante p 
        JOIN antropometrico a ON p.cod_participante = a.cod_participante 
        WHERE centro_educativo IS NOT NULL AND centro_educativo != ''
        GROUP BY centro_educativo";
        $stmt = $this->conexionDB->prepare($sql);
        $stmt->execute();
        return $stmt->fetchAll(PDO::FETCH_ASSOC);
    }

    public function familiaICA(){
        $sql = "SELECT familia_profesional, AVG(ant8) AS ica_promedio 
        FROM participante p 
        JOIN antropometrico a ON p.cod_participante = a.cod_participante 
        WHERE familia_profesional IS NOT NULL AND familia_profesional != ''
        GROUP BY familia_profesional";
    ...
    public function centroICA(){
        $sql = "SELECT centro_educativo, AVG(ant8) AS ica_promedio 
        FROM participante p 
        JOIN antropometrico a ON p.cod_participante = a.cod_participante 
        WHERE centro_educativo IS NOT NULL AND centro_educativo != ''
        GROUP BY centro_educativo";
     ...
     public function sexoICC(){
        $sql = "SELECT sexo, AVG(ant7) AS icc_promedio 
        FROM participante p 
        JOIN antropometrico a ON p.cod_participante = a.cod_participante 
        WHERE sexo IS NOT NULL AND sexo != ''
        GROUP BY sexo";
    ...
    public function familiaIMCP(){
        $sql = "SELECT p.familia_profesional, a.ant3 AS imc
        FROM participante p
        JOIN antropometrico a ON p.cod_participante = a.cod_participante
        WHERE p.familia_profesional IS NOT NULL 
        AND p.familia_profesional != ''
        AND a.ant3 IS NOT NULL
        AND a.ant3 > 10
        AND a.ant3 < 60";
        $stmt = $this->conexionDB->prepare($sql);
        $stmt->execute();
    ...
    public function grasaIMC(){
        $sql = "SELECT ant13 as grasa, ant3 AS imc
        FROM  antropometrico 
        WHERE ant13 IS NOT NULL 
        AND ant13 != ''
        AND ant13 > 5
        AND ant13 < 70
        AND ant3 IS NOT NULL
        AND ant3 > 10
        AND ant3 < 60";
        $stmt = $this->conexionDB->prepare($sql);
        $stmt->execute();
    ...
    public function dietaIMC(){
        $sql = "SELECT 
              a.ant3 AS imc,
              (al.Ali1 + al.Ali2 + al.Ali3 + al.Ali4 + al.Ali5 + 
               al.Ali6 + al.Ali7 + al.Ali8 + al.Ali9 + al.Ali10 + 
               al.Ali11 + al.Ali12 + al.Ali13 + al.Ali14) AS dieta
            FROM participante p
            JOIN antropometrico a ON p.cod_participante = a.cod_participante
            JOIN alimentacion al ON p.cod_participante = al.cod_participante
            WHERE a.ant3 IS NOT NULL
              AND a.ant3 > 10
              AND a.ant3 < 60
              AND al.Ali1 IS NOT NULL";
        $stmt = $this->conexionDB->prepare($sql);
        $stmt->execute();
        return $stmt->fetchAll(PDO::FETCH_ASSOC);
    }
    public function dietaICA(){
        $sql = "SELECT 
              a.ant8 AS ica,
              (al.Ali1 + al.Ali2 + al.Ali3 + al.Ali4 + al.Ali5 + 
               al.Ali6 + al.Ali7 + al.Ali8 + al.Ali9 + al.Ali10 + 
