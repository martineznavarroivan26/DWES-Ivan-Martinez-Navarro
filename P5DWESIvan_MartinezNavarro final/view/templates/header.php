...
<nav class="site-header d-flex justify-content-between align-items-center">
    <div class="menu site-menu d-flex justify-content-around">
        <?php if ($rol === 1): ?>
