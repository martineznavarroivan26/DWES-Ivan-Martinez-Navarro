...
<body>
    ...
    <?php if (!$hayParticipanteActivo && $needParticipante): ?>
        <section>
            ...
            <form action="./index.php" method="POST">
                ...
                <input id="cod_participante_required" name="cod_participante" type="number" min="1" required
                    value="<?php echo $codNuevo > 0 ? $codNuevo : ''; ?>"><br>
    ...
    <?php if ($hayParticipanteActivo): ?>
        ...
        <div>
            ...
            <a href="./index.php?action=forms&form=sueno" id="btnSueno">Habitos de sueño<?= etiquetaRellenado('sueno', $formulariosRellenados) ?></a>
