...
$accionesApi = ['sueno', 'actividad', 'alimentacion', 'antropometrico', 'todos', 'mostrarTodo'];
if ($_SERVER['REQUEST_METHOD'] === 'GET' && !isset($_GET['action']) && in_array($apiAction, $accionesApi, true) && $apiCod !== null && ctype_digit($apiCod)) {
